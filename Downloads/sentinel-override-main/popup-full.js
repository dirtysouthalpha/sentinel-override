...
const PROVIDER_PRESETS = {
  'zai': {
    ...
    models: ['zai-org-glm-4.7-flash', 'zai-org-glm-4.7', 'zai-org-glm-5.1'],
    defaultModel: 'zai-org-glm-4.7-flash'
  },
  'anthropic': {
    endpoint: 'https://api.anthropic.com/v1/messages',
    models: ['claude-haiku-4-5-20251001', 'claude-sonnet-4-6-20250514', 'claude-opus-4-7-20250605'],
  ...
  'openrouter': {
    ...
    models: ['anthropic/claude-sonnet-4-6-20250514', 'openai/gpt-4o-mini', 'google/gemini-2.5-flash', 'mistralai/mistral-7b-instruct-v0.2'],
    defaultModel: 'openai/gpt-4o-mini'
  },
  'venice': {
    endpoint: 'https://api.venice.ai/api/v1/chat/completions',
    models: ['gemma-4-uncensored', 'grok-41-fast', 'deepseek-v4-flash', 'mistral-small-3-2-24b-instruct', 'zai-org-glm-4.7-flash'],
  ...
  'poolside': {
    ...
    defaultModel: 'poolside/llama-3.3-70b-instruct'
  },
  'mimo': {
