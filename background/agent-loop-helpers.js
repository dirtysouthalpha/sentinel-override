...
export function buildVisionSystemPrompt() {
  return [
    ...
    'done(text) — Task complete. CRITICAL: Write your FINAL ANSWER here. Do NOT paste raw page_content or memory data. PROCESS the data: extract the specific fields the user asked for, filter relevant items, and write a clean structured answer. Example: if asked for "top 5 stories with points," write a numbered list with each story title and its points — NOT a raw page dump.',
    '</actions>',
    '',
    '<output_format>',
