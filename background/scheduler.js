...
function _fireAgentCompleteCallbacks() {
  ...
  if (cbs && Array.isArray(cbs)) {
    cbs.forEach(cb => { if (cb) { try { cb(); } catch (e) { console.error('Agent complete callback error:', (typeof e === 'object' && e !== null && 'message' in e && typeof e.message === 'string') ? e.message : String(e)); } } });
  }
}
...
async function loadSchedules() {
  try {
    ...
    console.warn('[Sentinel/scheduler] loadSchedules failed:', (typeof e === 'object' && e !== null && 'message' in e && typeof e.message === 'string') ? e.message : String(e));
    return {};
  }
}
...
async function saveSchedules(schedules) {
  try {
    ...
    console.warn('[Sentinel/scheduler] saveSchedules failed:', (typeof e === 'object' && e !== null && 'message' in e && typeof e.message === 'string') ? e.message : String(e));
  }
}
...
async function loadResults() {
  try {
    ...
    console.warn('[Sentinel/scheduler] loadResults failed:', (typeof e === 'object' && e !== null && 'message' in e && typeof e.message === 'string') ? e.message : String(e));
    return {};
  }
}
...
async function saveResults(results) {
  try {
    ...
    console.warn('[Sentinel/scheduler] saveResults failed:', (typeof e === 'object' && e !== null && 'message' in e && typeof e.message === 'string') ? e.message : String(e));
  }
}
...
function setBadge(status) {
  ...
  if (_t && typeof _t.catch === 'function') _t.catch((e) => {
    console.error('[_t] Unhandled rejection:', (typeof e === 'object' && e !== null && 'message' in e && typeof e.message === 'string') ? e.message : String(e));
  });
  const _b = chrome.action.setBadgeBackgroundColor({
    color: status === 'success' ? '#22c55e' : '#ef4444',
  });
  if (_b && typeof _b.catch === 'function') _b.catch((e) => {
    console.error('[_b] Unhandled rejection:', (typeof e === 'object' && e !== null && 'message' in e && typeof e.message === 'string') ? e.message : String(e));
  });
}
...
export async function executeScheduledTask(alarmName) {
  ...
  try {
    ...
    console.error('Failed to store scheduled task result:', (typeof e === 'object' && e !== null && 'message' in e && typeof e.message === 'string') ? e.message : String(e));
    try { tel.error('scheduler', 'Failed to store result', { error: (typeof e === 'object' && e !== null && 'message' in e && typeof e.message === 'string' ? e.message : String(e)) }); } catch (nestedErr) { console.error('[Sentinel] Error in scheduler.js:', (typeof nestedErr === 'object' && nestedErr !== null && 'message' in nestedErr && typeof nestedErr.message === 'string') ? nestedErr.message : String(nestedErr)); }
  }
  ...
  try {
    ...
    console.error('Failed to save schedule state after execution:', (typeof e === 'object' && e !== null && 'message' in e && typeof e.message === 'string') ? e.message : String(e));
    try { tel.error('scheduler', 'Failed to save schedule state', { error: (typeof e === 'object' && e !== null && 'message' in e && typeof e.message === 'string' ? e.message : String(e)) }); } catch (nestedErr) { console.error('[Sentinel] Error in scheduler.js:', (typeof nestedErr === 'object' && nestedErr !== null && 'message' in nestedErr && typeof nestedErr.message === 'string') ? nestedErr.message : String(nestedErr)); }
  }
