...
// The full five-character escaper, shared by both report pages. report-view
// carried its own copy while report-print had NONE and fell back to escaping
// only `<` when marked was unavailable — the classic drift this file exists
// to prevent.
...
// In a browser classic script the function declarations above are already
// globals. The explicit handle is for Node/jest, where this file is imported
// as a module and top-level declarations stay module-scoped.
globalThis.ReportSanitize = { sanitizeReportHtml, escapeHtml };
