"""Health check for Shoko anime metadata server."""
import json
import sys
...
SERVICE_NAME = "shoko"
# Shoko /api/v3/Init/Status returns server initialization state without auth
DEFAULT_HEALTH_PATH = "/api/v3/Init/Status"
