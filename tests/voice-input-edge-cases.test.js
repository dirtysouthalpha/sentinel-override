...
describe('Voice input edge cases', () => {
  ...
  test('handles script injection permission denied', async () => {
    ...
    try {
      ...
      expect(typeof e === 'object' && e !== null && typeof e.message === 'string' ? e.message : String(e)).toContain('Cannot access');
    }
  });
  ...
  test('handles tab closing during voice input', async () => {
    ...
    try {
      ...
      expect(typeof e === 'object' && e !== null && typeof e.message === 'string' ? e.message : String(e)).toContain('Tab closed');
    }
  });
